...
function generateFlowchart() {
  ...
  fetch(`${BASE_URL}/flowchart`, {
    ...
    .then(data => {
      ...
      renderDiv.innerHTML = `<img src="${BASE_URL}${data.imageUrl}" alt="Generated Flowchart" style="max-width: 100%; border-radius: 8px;" />`;

      const img = document.createElement("img");
      img.src = `${BASE_URL}${data.imageUrl}`;
